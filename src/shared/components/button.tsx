...
export enum ButtonType {
  ...
  CARUSEL_BTN = 'h-full tabletM:h-fit tabletM:p-5 tabletM:bg-black-600 max-tabletM:w-1/2 w-fit rounded-2xl max-tabletM:absolute opacity-20 tabletM:opacity-40 hover:border-blue-700 tabletM:border-2',
